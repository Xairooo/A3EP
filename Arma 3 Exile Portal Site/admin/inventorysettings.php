...
if(isset($_POST['settingsform']))
		{
			$on = $_POST['module_e'];
				...
				if($row['module_enabled'] != $on){
			$settingClass->enableModule('inventory', $on);
		}
		 header("location: inventorysettings.php");
		}
		?>
<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <?php echo $langs->word($dlang,'inventory'); ?> <?php echo $langs->word($dlang,'settings'); ?>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> <?php echo $langs->word($dlang,'home'); ?></a></li>
        <li> <?php echo $langs->word($dlang,'portal'); ?></li>
        <li class="active"><?php echo $langs->word($dlang,'inventory'); ?> <?php echo $langs->word($dlang,'settings'); ?></li>
      </ol>
    </section>
...
<div class="form-group">
                ...
                <!-- /.box-footer -->
                	<div align="center" class="box-footer">
								<button type="submit" name="settingsform" class="btn btn-info "><?php echo $langs->word($dlang,'save');?></button>
							</div>
							</form>
              </div>
              <!--/.box -->
