...
if(isset($_POST['settingsform']))
		{
			...
			$settingClass->enableModule('territories', $garage_on);
		}
		 header("location: tcsettings.php");
		}
		?>
<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <?php echo $langs->word($dlang,'territory_clan'); ?> <?php echo $langs->word($dlang,'settings'); ?>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> <?php echo $langs->word($dlang,'home'); ?></a></li>
        <li> <?php echo $langs->word($dlang,'portal'); ?></li>
        <li class="active"> <?php echo $langs->word($dlang,'territory_clan'); ?> <?php echo $langs->word($dlang,'settings'); ?></li>
      </ol>
    </section>
